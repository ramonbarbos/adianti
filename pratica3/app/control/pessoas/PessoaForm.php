...
class PessoaForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $cidade_id = new TDBCombo('cidade_id', 'sample', 'Cidade', 'id', 'nome', 'nome', $filter);
        $grupo_id = new TDBUniqueSearch('grupo_id', 'sample', 'Grupo', 'id', 'nome');
        $papeis_id = new TDBMultiSearch('papeis_id', 'sample', 'Papel', 'id', 'nome');
        $estado_id = new TDBCombo('estado_id', 'sample', 'Estado', 'id', '{nome} ({uf})');
    ...
    public static function onChangeEstado($param)
    {
        try
        {
            ...
            if (!empty($param['estado_id']))
            {
                ...
                TDBCombo::reloadFromModel('form_Pessoa', 'cidade_id', 'sample', 'Cidade', 'id', '{nome} ({id})', 'nome', $criteria, TRUE);
            }
            else
            {
